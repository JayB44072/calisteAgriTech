...
const statusConfig: Record<string, { label: string; classes: string; dot: string }> = {
  ...
  // Matériels
  actif: { label: "Actif", classes: "bg-emerald-50 text-emerald-700 border-emerald-200", dot: "bg-emerald-500 animate-pulse" },
  ...
  en_cours: { label: "En cours", classes: "bg-emerald-50 text-emerald-700 border-emerald-200", dot: "bg-emerald-500 animate-pulse" },
  ...
  resolu: { label: "Résolu", classes: "bg-emerald-50 text-emerald-700 border-emerald-200", dot: "bg-emerald-500" },
